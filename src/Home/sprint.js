...
filterCaseInsensitive = (filter, row) => {
  ...
  <div className="tabs">
    <label htmlFor="radio1" id="first-tab" className="tab active">
      <div className="tab-label" onClick={ () => {this.handletab1();}}>Pending Sprint</div>
    </label>
    <label htmlFor="radio2" id="second-tab" className="tab">
      <div className="tab-label" onClick={ () => {this.handletab2();}}>Current Sprint</div>
    </label>
  </div>
    ...
    <tr style={{height: '100%'}}>
      <td style={{color: '#333333', fontSize: '0.8em'}}>
        <table className="table-content" cellPadding="0px" cellSpacing="0px" width="100%">
          <tbody><tr>
              <td className="sub-head" style={{backgroundColor: "#ffdead00",float: "left" , padding:"7px"}}>Pending Sprint</td>
            </tr>
            <tr>
...
<label htmlFor="radio2" id="second-tab" className="tab" style={{width:"100%"}}>
      <button type="submit" style={{backgroundColor: "#4c4a48",color: "#fff",border: "none",padding: "7px 15px",marginTop: "10px",borderRadius: "6px"}} className='tab-label'  onClick={ () => {this.handletab2();}} >Next</button>
    </label>
    </div>
